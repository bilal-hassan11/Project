                ...
                <div class="card-block pt-2 pb-0">
                    <div class="media">
                        <div class="media-body white text-left">
                            <h3 class="font-large-1 mb-0"  id="inventories"><?=($incoming->qty  == '') ? 0 : $incoming->qty ?></h3>
        ...
        <div class="card gradient-blackberry">
            <div class="card-body" id="chart">
                <div class="card-block pt-2 pb-0">
                    <div class="media">
                        <div class="media-body white text-left">
                            <h3 class="font-large-1 mb-0"  id="inventories"><?=($inventories->qty  == '') ? 0 : $inventories->qty ?></h3>
        ...
        <div class="card gradient-ibiza-sunset">
            <div class="card-body" id="chart">
                <div class="card-block pt-2 pb-0">
                    <div class="media">
                        <div class="media-body white text-left">
                            <h3 class="font-large-1 mb-0"  id="size_user"><?=($size_user == '') ? 0 : $size_user?> sqft</h3>
            ...
            <div class="card-body">
              <div class="card-block mcontainer">
                <table class="table table-striped table-bordered table-hover table-checkable order-column display" id="orders" style="width:100%">
                    ...
                    <tbody>
                    <?php $i=0; foreach ($low_stock as $value) { ?>
                      <tr>
                        <td><?=++$i?></td>
                        <td><?php echo $value['username']?></td>
                        <td>
                          <?php if(file_exists('uploads/'.$value['image'])) { ?>
                          <img src="<?=base_url();?>uploads/<?php echo $value['image'] ?>" width='100' class='img-thumbnail'>
                          <?php } else {
                             echo "No Image";
                           } ?>
                        </td>
                        ...
                        <td><span class='badge badge-dark'><?php echo $value['status']; ?></span></td>
